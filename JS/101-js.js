...
function isPositive(RandomNumber) {

    (randomNumber % 2 === 0) ? console.log(true) : console.log(false);
}
isPositive(randomNumber);
...
function isNegative(NumberToTest) {
    (NumberToTest % 2 === 0) ? console.log(false) : console.log(true);
}
...
function isOdd(NumberToTest) {
    (NumberToTest % 2 === 1) ? console.log(false) : console.log(true);
}
...
function quotient(numbers) {
    return numbers;
}
console.log(quotient(27 % 9))
...
console.log(sumOfSquares((3 * 3) + (2 * 2)))
...
function timesTwoPlusThree(numbers) {
    return numbers;
}
console.log(timesTwoPlusThree((0 * 2) + 3))
...
function areaOfRectangle(numbers) {
    return numbers;
}
...
assert(third("1ubuntu"), "u", "Exercise 52");
